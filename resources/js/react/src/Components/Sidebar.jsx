...
const Sidebar = ({
    ...
    return (
        <div
            ...
            } transition-opacity lg:relative lg:bg-transparent lg:opacity-100`}
            onClick={() => setIsOpen(false)}
        >
            <div
                className={`w-72 h-full bg-white shadow-lg transition-transform transform ${
                    isOpen ? "translate-x-0" : "-translate-x-full"
                                ...
                                return (
                                    <li key={item.name}>
                                        <Link
                                            to={item.href}
                                            onClick={() => setIsOpen(false)}
                                            className={`block p-2 rounded text-sm font-medium ${
                                                isActive
